package com.enkitstudio.restaurant.shared.collection.domain;
...
@UnitTest
class AIsampleCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class AIsampleCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = AIsampleCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = AIsampleCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class AIsampleCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = AIsampleCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = AIsampleCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class AIsampleCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = AIsampleCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = AIsampleCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class AIsampleMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = AIsampleCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = AIsampleCollections.immutable(input);
